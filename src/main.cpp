...
// Copyright (c) 2013 The Zingcoin developers
...
uint256 hashGenesisBlock("0x00000bc03a62060822e0e7612d26302881796b4484290a55ff3e09df5dcfb889");
static const unsigned int timeGenesisBlock = 1402346500;
...
const string strMessageMagic = "Zingcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 30; // 30 sec
static const int64 nTargetSpacing = 30; // 30 sec
static const int64 nInterval = nTargetTimespan / nTargetSpacing; // 1 blocks (retarget every block)
...
if(nHeight < 10000 && nHeight > 300)
{
iMax = 30;
}
if(nHeight < 50000 & nHeight > 10000)
{
iMax = 20;
}
if(nHeight > 50000)
...
iMax = 2;
    ...
    nMaxCoinPerBlock = nSubsidy + nFees;
    nMaxCoinPerBlock = nMaxCoinPerBlock * 10;
...
static const int64 nAveragingInterval = 8; // blocks
static const int64 nAveragingTargetTimespan = nAveragingInterval * nTargetSpacing; // 24 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000008b806b5408ac1d3390af63aa9fe0a6860483f5bb0513b32c403b61b97f5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Zing for you, Zing for me, Zing for all!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x834e9205a1ee64d7cb8cb689b304a8aedaf5ca34ad85ac704fd617df2418ac5b"));
...
unsigned char pchMessageStart[4] = { 0xa5, 0xde, 0xfe, 0x04 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ZingcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ZingcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("ZingcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("zingcoin-miner");
    ...
    try { loop {
        ...
        printf("Running ZingcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("ZingcoinMiner terminated\n");
        throw;
    }
}
